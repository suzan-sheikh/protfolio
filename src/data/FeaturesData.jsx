...
export const FeaturesData = [
  {
    ...
    icon: <FaCode />,
    des: "I create my project use JavaScript and modern javaScript libraries like React.js, Next.js, Express.js and server-side like MongoDB and Node.js.",
  },
  {
    id: 3,
    icon: <SiProgress />,
  ...
  },
  {
    ...
    des: "In addition to being a developer, I currently serve as a supervisor for office assistants at my workplace.",
  },
